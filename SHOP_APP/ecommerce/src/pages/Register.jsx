...
const Register = () => {
  ...
  const handleClick = (e) => {
    e.preventDefault();
          ...
          swal({
            title: "New User",
            text: "You Registred Succussfully.",
            icon: "success",
            button: "Go Back!",
          });
    ...
    <Container>
      <Wrapper>
        ...
        <Form>
          ...
          <Input placeholder="Phone" name="phone" type="number" onChange={handleChange} />
          <Input placeholder="Gender" name="gender" type="text" onChange={handleChange}  />
